...
int menu3()
{
    ...
    do
    {
        ...
        puts("**   Regras   **");
        puts("****************\n");
        puts("- Na sua vez, cada jogador coloca a sua peca num dos 9 mini-tabuleiros");
        puts("- Um jogador que tenha 3 em linha num dos mini-tabuleiros ganha essa seccao");
        puts("- Um jogador que ganhe 3 mini-tabuleiros em linha (no tabuleiro grande) ganha o jogo");
        puts("- A posicao escolhida pelo adversario identifica o mini-tabuleiro onde deve ser continuado o jogo");
        puts("- Caso haja um vencedor num mini-tabuleiro a continuacao do jogo sera feita no proximo mini-tabuleiro");
        puts("- Verifica-se um empate se o jogo chegar ao final sem que nenhum dos jogadores consiga fazer 3 mini-tabuleiros em linha.");
        puts("- O jogador1 e o primeiro a comecar a jogar.");
        puts("- O jogo comeca num tabuleiro aleatorio.\n");
        puts("1 - Voltar");
...
void GuardaJogobin(struct Lista *L)
{
    ...
    {
        fprintf(stderr, "\nErro na abertura do ficheiro para escrever!\n\n", "jogo.bin");
        return;
    }
...
int Jogadas(Tab TabuleiroJogo, Jogador Jogador1, Jogador Jogador2, Jogador BOT, int *nJogador, int *mT, struct Lista **L, int AI)
{
    ...
    if (*nJogador == 1)
    {
        ...
        if (TabuleiroJogo.miniTab == 1)
        {
            ...
            InsereJogada(L, TabuleiroJogo.linha, TabuleiroJogo.coluna, TabuleiroJogo.miniTab, AI, *nJogador);
